...
class CLUB_Editor {
    ...
    public static function render() {
        ...
        <div class="club-cms">
            ...
            <header class="club-cms-header">

                <div class="club-cms-title">
                    CLUB CMS
                </div>

                <div class="club-cms-user">
                    <?php echo esc_html( $user->display_name ); ?>
                </div>

            </header>

            <div class="club-cms-main">

                <aside class="club-cms-sidebar">
                    ...
                    <ul>
                        ...
                        foreach ( CLUB_Module::all() as $id => $module ) :
                ...
                <section class="club-cms-content">
