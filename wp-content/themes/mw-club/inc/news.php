...
function club_news_shortcode() {
    ...
    <div class="club-news-box">
        ...
        <div class="club-box-title">
            <span class="dashicons dashicons-media-document"></span>
            Aktuelle Neuigkeiten
        </div>

        <?php if ( current_user_can( 'edit_posts' ) ) : ?>
            <a class="club-news-add" href="<?php echo esc_url( admin_url( 'post-new.php' ) ); ?>">
                + Neue Neuigkeit
            </a>
        <?php endif; ?>
        ...
        <?php if ( $query->have_posts() ) : ?>
            ...
            <?php while ( $query->have_posts() ) : $query->the_post(); ?>
                ...
                <div class="club-news-item">

                    <?php if ( has_post_thumbnail() ) : ?>
                        <div class="club-news-image">
...
add_shortcode( 'club_news', 'club_news_shortcode' );