 ...
 */
add_filter( 'logout_redirect', 'club_logout_redirect', 10, 3 );

function club_logout_redirect( $redirect_to, $requested_redirect_to, $user ) {
 ...
 * - menu-logout
 */
add_filter( 'wp_nav_menu_objects', 'club_dynamic_menu_items', 20 );

function club_dynamic_menu_items( $items ) {
